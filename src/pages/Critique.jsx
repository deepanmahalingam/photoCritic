...
export default function Critique() {
  ...
  const handleAnalyze = async () => {
    ...
    try {
      const critique = await critiquePhoto(file, settings.apiKey, settings.provider)
      setResult(critique)
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-400 mt-1">Upload a photo to receive AI-powered feedback.</p>
      </div>
